...
document.onreadystatechange = function () {
  if (document.readyState == "interactive") {
    ...
    if (
      ...
      document
        .querySelector("#text-oslab-hero")
        .classList.add("text-oslab-dark");
      document
        .querySelector("#text-oslab-whatcanido")
        .classList.remove("text-oslab-whatcanido");
      document
        .querySelector("#text-oslab-whatcanido")
        .classList.add("text-oslab-whatcanido-dark");
      ...
      document
        .querySelector("#text-oslab-hero")
        .classList.remove("text-oslab-dark");
      document.querySelector("#text-oslab-hero").classList.add("text-oslab");
      document
        .querySelector("#text-oslab-whatcanido")
        .classList.remove("text-oslab-whatcanido-dark");
      document
        .querySelector("#text-oslab-whatcanido")
        .classList.add("text-oslab-whatcanido");
...
const lazy_container3 = new IntersectionObserver((entries) => {
  ...
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      entry.target
        .querySelector("#boxs-frontend div")
        .classList.remove("inactive-box");
      entry.target
        .querySelector("#boxs-frontend div")
        .classList.add("active-box");
      entry.target
        .querySelector("#boxs-backend div")
        .classList.remove("inactive-box");
      entry.target
        .querySelector("#boxs-backend div")
        .classList.add("active-box");
...
const lazy_container4 = new IntersectionObserver(
  (entries) => {
    entries.forEach((entry) => {
